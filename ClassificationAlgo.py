...
lb1 = Label(window, text=".......Welcome to world of classification Algorithms..........")
lb1.configure(bg='skyblue',fg='black')
lb1.grid(column=1, row=0)
lb2 = Label(window,text="...........Click Here for Results........")
lb2.configure(bg='orange',fg='black')
...
btn =Button(window, text="Naive Bayes",command=clicked)
btn.grid(column=1, row=4)
btn.configure(bg="orange",fg="blue")
btn =Button(window, text="PRN CLassification",command=clickedN)
btn.grid(column=6, row=4)
btn.configure(bg="orange",fg="blue")

btn=Button(window,text="PR Curve",command=PRC)
btn.grid(column=10,row=4)
btn.configure(bg="orange",fg="blue")



btn =Button(window, text="KNN      ",command=clicked1)
btn.grid(column=1, row=6)
btn.configure(bg="yellow",fg="red")

btn =Button(window, text="PRK Classification",command=clickedK)
btn.grid(column=6, row=6)
btn.configure(bg="yellow",fg="red")

btn =Button(window, text="PR Curve",command=PRCK)
btn.grid(column=10, row=6)
btn.configure(bg="yellow",fg="red")



btn =Button(window, text="Logistic ",command=clicked2)
btn.grid(column=1, row=8)
btn.configure(bg="orange",fg="blue")

btn =Button(window, text="PRL Classification",command=clickedL)
btn.grid(column=6, row=8)
btn.configure(bg="orange",fg="blue")

btn =Button(window, text="PR Curve ",command=PRCL)
btn.grid(column=10, row=8)
btn.configure(bg="orange",fg="blue")



btn =Button(window, text="SVM      ",command=clicked3)
btn.grid(column=1, row=10)
btn.configure(bg="yellow",fg="red")

btn =Button(window, text="PRS Classification",command=clickedS)
btn.grid(column=6, row=10)
btn.configure(bg="yellow",fg="red")

btn =Button(window, text="PR Curve ",command=PRS)
btn.grid(column=10, row=10)
btn.configure(bg="yellow",fg="red")


btn=Button(window,text="Hyperplane ",command=HP)
btn.grid(column=1,row=12)
btn.configure(bg="orange",fg="blue")

btn =Button(window, text="Comparison",command=clickedC)
btn.grid(column=6, row=12)
btn.configure(bg="orange",fg="blue")
